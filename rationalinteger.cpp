...
RationalInteger::RationalInteger( long int iVal )
: iVal( iVal )
{
}

RationalInteger::RationalInteger( const RationalInteger& ri )
: iVal( ri.iVal )
{
}
...
long int RationalInteger::get_iValue() const
{
	return iVal;
}
...
bool RationalInteger::bIsLessThan( const int& n ) const
{
	return ( iVal < n );
}

bool RationalInteger::bIsGreaterThan( const int& n ) const
{
	return ( iVal > n );
}
...
bool RationalInteger::bIsEqualTo( const int& n ) const
{
	return ( iVal == n );
}
...
string RationalInteger::to_string( const string& strFormat, const bool& bProtect ) const
{
	return std::to_string( iVal );
}

double RationalInteger::to_double() const
{
	return (double)iVal;
}

string RationalInteger::get_classname() const
{
	return "RationalInteger";
}
