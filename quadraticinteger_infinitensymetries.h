...
namespace Eigen 
{
	...
	template<> struct NumTraits<Rational<QuadraticIntegerBig>> ///< \struct NumTraits<Rational<QuadraticIntegerBig>> quadraticinteger_infinitensymetries.h "Specialization for Eigen matrices to QuadraticIntegerBig type"
	{
	...
	namespace internal {
		template<>
		struct significant_decimals_impl<Rational<QuadraticIntegerBig>> ///< \struct significant_decimals_impl<Rational<QuadraticIntegerBig>> quadraticinteger_infinitensymetries.h "Specialization for Eigen matrices to QuadraticIntegerBig type"
		{
...
{
	private:
		vector< Matrix< Rational<QuadraticIntegerBig>, Dynamic, 1 > > rqiVectorsC; ///< Vectors found by AlVin, in column
		vector< vector< Rational<QuadraticIntegerBig> > > qiDottedWeights; ///< Weights of the dotted lines
		
		Matrix< Rational<QuadraticIntegerBig>, Dynamic, Dynamic > rqiBasisFixedPoints; ///< Basis of the fixed points of the involutions, in column
		
		vector< Rational<QuadraticIntegerBig> > rqiQF; ///< Coefficients of the diagonal quadratic form (in fractions)
		vector< vector< QuadraticIntegerBig > > riVectorsProducts; ///< Products of each pair of vecteurs
